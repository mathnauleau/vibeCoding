...
echo ""
echo "Next steps:"
echo "1. Customize your resume and cover letter"
echo "2. Update the Keynote presentation"
echo "3. Review the company research notes"
echo "4. Update the Notion entry with additional details"